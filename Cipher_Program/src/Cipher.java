...
public class Cipher {
	...
	public static void main(String[] args) {
		...
		// - - Generates the plaintext number and random key for the Modulo 10
		...
		if (Total < 10) { // conditional statement giving the leading zero and encoded number if Total <
							// 10.
			Total_1 = Total - Total;
		...
		if (Total >= 10) { // conditional statement giving the encoded number if Total >= 10.
			...
			// Check-system code to ensure that the right values of the individual encoded
			// digits are being calculated
